...
export function BwhaleStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--bwhale-cover)' }}>
              <span className={css.coverName}>Blue Whale Ocean</span>
            </div>
