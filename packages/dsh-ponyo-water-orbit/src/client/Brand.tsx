 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Ponyo Water Orbit".
 *
 ...
 */
export function PonyoMark({ size, className }: BrandMarkProps) {
  return (
    <span
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Ponyo Water Orbit".
 *
 ...
 */
export function PonyoName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Ponyo Water Orbit</small>
    </span>
  )
}
