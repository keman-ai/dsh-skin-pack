...
/** How many rows the forest-tracks card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function ForestStatusProbe({ useProjection, useSession }: StatusProbeProps) {
