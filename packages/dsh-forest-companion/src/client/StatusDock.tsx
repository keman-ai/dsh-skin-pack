...
export function ForestStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--forest-cover)' }}>
              <span className={css.coverName}>Forest Companion Skin</span>
            </div>
