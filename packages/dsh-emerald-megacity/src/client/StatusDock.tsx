...
export function EmeraldStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--emerald-cover)' }}>
              <span className={css.coverName}>Emerald Megacity</span>
            </div>
