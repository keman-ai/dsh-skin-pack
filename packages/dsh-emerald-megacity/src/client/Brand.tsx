 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Emerald Megacity".
 *
 ...
 */
export function EmeraldMark({ size, className }: BrandMarkProps) {
  return (
    <span
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Emerald Megacity".
 *
 ...
 */
export function EmeraldName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Emerald Megacity</small>
    </span>
  )
}
