 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Pearl Oracle".
 *
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Pearl Oracle".
 *
