...
export function PearlStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--pearl-cover)' }}>
              <span className={css.coverName}>Pearl Oracle</span>
            </div>
