...
export function XianStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--xian-cover)' }}>
              <span className={css.coverName}>Tianji Pavilion</span>
            </div>
