 ...
 *
 * The prototype's sidebar carries a rounded square mark in its top-left corner (a deep blue gradient, a cool blue border and a cyan glow, holding the character 天)
 ...
 * The prototype's own sidebar mark is likewise the character 天.
 *
 * @param props - Size and class name from the host.
 * @returns The square mission badge.
 */
export function MistMark({ size, className }: BrandMarkProps) {
  return (
    <svg
      className={className}
      width={size}
