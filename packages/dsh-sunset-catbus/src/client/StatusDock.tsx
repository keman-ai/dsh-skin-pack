...
export function CatbusStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--catbus-cover)' }}>
              <span className={css.coverName}>Sunset Catbus</span>
            </div>
