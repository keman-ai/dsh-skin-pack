...
/** How many rows the stops card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function CatbusStatusProbe({ useProjection, useSession }: StatusProbeProps) {
