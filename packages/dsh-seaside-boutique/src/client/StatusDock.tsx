/**
 * The right-hand dock: a reduced seaside cover plus this session's real state.
 *
...
export function SeasideStatusDock() {
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--seaside-cover)' }}>
              <span className={css.coverName}>Seaside Boutique</span>
            </div>
