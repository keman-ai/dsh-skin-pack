 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Night Flight Companion".
 *
 ...
 */
export function NightMark({ size, className }: BrandMarkProps) {
  return (
    <span
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Night Flight Companion".
 *
 ...
 */
export function NightName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>deepseek</strong>
      <small className={css.subtitle}>Night Flight Companion</small>
    </span>
  )
}
