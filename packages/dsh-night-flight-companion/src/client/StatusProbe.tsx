...
/** How many rows the flight-log card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function NightStatusProbe({ useProjection, useSession }: StatusProbeProps) {
