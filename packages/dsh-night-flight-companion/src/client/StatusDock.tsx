...
export function NightStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--night-cover)' }}>
              <span className={css.coverName}>Night Flight Companion</span>
            </div>
