...
/** How many rows the sortie-log card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function UltrateamStatusProbe({ useProjection, useSession }: StatusProbeProps) {
