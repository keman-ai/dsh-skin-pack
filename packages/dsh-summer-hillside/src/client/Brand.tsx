 ...
 *
 * The prototype's sidebar carries a rounded square mark in its top-left corner (a deep blue gradient, a cool blue border and a cyan glow, holding the character 夏, summer)
 ...
 */
export function HillsideMark({ size, className }: BrandMarkProps) {
  return (
    <svg
      className={className}
      width={size}
 ...
 */
export function HillsideName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Summer Hillside</small>
    </span>
  )
}
