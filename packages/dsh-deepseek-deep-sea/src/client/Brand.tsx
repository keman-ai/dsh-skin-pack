 ...
 * beside it, two lines reading "DeepSeek Harness / Whale Girl · Deep Sea Theme".
 *
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "DeepSeek Harness / Whale Girl · Deep Sea Theme".
 *
...
export function FishName() {
  return (
    <span className={css.name}>
      ...
      <small className={css.subtitle}>Whale Girl · Deep Sea</small>
    </span>
  )
}
