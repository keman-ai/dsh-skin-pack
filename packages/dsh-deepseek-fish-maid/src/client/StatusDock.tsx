...
/** 展开状态的存储键。 */
const STORAGE_KEY = 'fish.dock.open'

/** 展开时打在 body 上，供样式表把主区让出来。 */
const OPEN_ATTRIBUTE = 'data-fish-dock-open'

/** 本皮肤激活时打在 body 上的标记，与 client/index.ts 的 BODY_ATTRIBUTE 一致。 */
const SKIN_ATTRIBUTE = 'data-dsh-fish'
...
export function FishStatusDock() {
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--fish-cover)' }}>
              <span className={css.coverName}>大肥鱼娘</span>
            </div>
