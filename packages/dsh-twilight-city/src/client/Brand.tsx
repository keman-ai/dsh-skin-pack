 ...
 *
 * The prototype's sidebar carries a rounded square mark in its top-left corner (a deep blue gradient, a cool blue border and a cyan glow, holding the character 暮)
 * plus a two-line wordmark, "DeepSeek Harness / Twilight City". The harness exposes both as slots:
...
export function TwilightName() {
  return (
    <span className={css.name}>
      ...
      <small className={css.subtitle}>Twilight City</small>
    </span>
  )
}
