...
/** How many rows the tool-trace card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function TwilightStatusProbe({ useProjection, useSession }: StatusProbeProps) {
