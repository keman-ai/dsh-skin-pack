...
/** How many rows the night-run card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function NforestStatusProbe({ useProjection, useSession }: StatusProbeProps) {
