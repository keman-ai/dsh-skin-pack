 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Night Forest Companion".
 *
 ...
 */
export function NforestMark({ size, className }: BrandMarkProps) {
  return (
    <span
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Night Forest Companion".
 *
 ...
 */
export function NforestName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Night Forest Companion</small>
    </span>
  )
}
