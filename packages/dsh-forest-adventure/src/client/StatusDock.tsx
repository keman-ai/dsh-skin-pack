...
export function GroveStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--grove-cover)' }}>
              <span className={css.coverName}>Forest Adventure</span>
            </div>
