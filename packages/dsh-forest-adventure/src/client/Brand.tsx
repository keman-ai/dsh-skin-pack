 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Forest Adventure".
 *
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Forest Adventure".
 *
...
export function GroveName() {
  return (
    <span className={css.name}>
      ...
      <small className={css.subtitle}>Forest Adventure</small>
    </span>
  )
}
