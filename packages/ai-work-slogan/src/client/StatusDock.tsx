...
/** 展开状态的存储键。 */
const STORAGE_KEY = 'ai-work.dock.open'

/** 展开时打在 body 上，供样式表把主区让出来。 */
const OPEN_ATTRIBUTE = 'data-ai-work-dock-open'

/** 本皮肤激活时打在 body 上的标记，与 client/index.ts 的 BODY_ATTRIBUTE 一致。 */
const SKIN_ATTRIBUTE = 'data-dsh-ai-work'
...
export function WorkStatusDock() {
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.badge}>
              ...
              <span className={css.badgeText}>AI Work Mode</span>
            </div>
