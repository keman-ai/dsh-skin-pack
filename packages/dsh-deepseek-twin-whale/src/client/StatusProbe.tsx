...
/** How many rows the tidy-up log lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function TwinwhaleStatusProbe({ useProjection, useSession }: StatusProbeProps) {
