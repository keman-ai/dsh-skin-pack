/**
 * The Twin Whale Girl skin · host half.
 *
...
export interface Config {
  /**
   * Switch to Twin Whale Girl on install; on by default. Turned off, it only registers without applying, leaving the user to pick it under Settings → Appearance.
   *
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.logger.info('[twinwhale] Twin Whale Girl mounted (%s)', mode)
}
