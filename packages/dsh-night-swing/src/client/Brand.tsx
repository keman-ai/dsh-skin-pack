 ...
 * with a faint blue shadow, beside two lines reading "deepseek / Night Swing".
 *
...
/**
 * The wordmark: a primary name plus a subtitle, matching the prototype's "deepseek / Night Swing".
 *
