...
/** 展开状态的存储键。 */
const STORAGE_KEY = 'twinmaid.dock.open'

/** 展开时打在 body 上，供样式表把主区让出来。 */
const OPEN_ATTRIBUTE = 'data-twinmaid-dock-open'

/** 本皮肤激活时打在 body 上的标记，与 client/index.ts 的 BODY_ATTRIBUTE 一致。 */
const SKIN_ATTRIBUTE = 'data-dsh-twinmaid'
...
export function TwinmaidStatusDock() {
      ...
      {open && (
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            <div className={css.cover} style={{ backgroundImage: 'var(--twinmaid-cover)' }}>
              <span className={css.coverName}>双鲸女仆</span>
            </div>
