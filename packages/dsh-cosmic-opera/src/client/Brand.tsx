 ...
 *
 * The prototype's sidebar carries a rounded square mark in its top-left corner (a deep blue gradient, a cool blue border and a cyan glow, holding the mission code `DH`)
 ...
 */
export function OperaMark({ size, className }: BrandMarkProps) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <defs>
        <linearGradient id="cosmic-mark" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#173266" />
 ...
 */
export function OperaName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Cosmic Opera</small>
    </span>
  )
}
