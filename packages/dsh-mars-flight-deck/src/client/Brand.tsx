 ...
 */
export function MarsMark({ size, className }: BrandMarkProps) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <defs>
        <linearGradient id="cosmic-mark" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#142331" />
 ...
 */
export function MarsName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Mars Flight Deck</small>
    </span>
  )
}
