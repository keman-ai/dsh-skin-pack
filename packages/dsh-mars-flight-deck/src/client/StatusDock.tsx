...
export function MarsStatusDock() {
        ...
        <div className={css.body}>
          ...
          <div className={css.scroll}>
            ...
            */}
            {toolCalls.length > 0 && (
              <section className={css.card}>
                <div className={css.cardTitle}>SYSTEM OPS</div>
            ...
            */}
            {contextEntries.length > 0 && (
              <section className={css.card}>
                <div className={css.cardTitle}>CONTEXT UPLINK</div>
                <ul className={css.log}>
