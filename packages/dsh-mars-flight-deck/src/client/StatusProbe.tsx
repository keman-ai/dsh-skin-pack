...
/** How many rows the SYSTEM OPS card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
const TOOL_LOG_LIMIT = 6

/** How many rows the CONTEXT UPLINK card lists at most. */
...
export function MarsStatusProbe({ useProjection, useSession }: StatusProbeProps) {
