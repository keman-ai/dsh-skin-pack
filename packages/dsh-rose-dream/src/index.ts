 ...
 */
export const COVER_ROUTE = '/skin-cover/rose.webp'
...
export interface Config {
  /**
   * Switch to Rose Dream on install; on by default. Turned off, it only registers without applying, leaving the user to pick it in the skin market.
   *
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.logger.info('[rose] Rose Dream mounted (%s)', mode)
}
