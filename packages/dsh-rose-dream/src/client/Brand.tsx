 ...
 *
 * The prototype's sidebar carries a rounded square mark in its top-left corner (a deep blue gradient, a cool blue border and a cyan glow, holding the character 玫, rose)
 ...
 */
export function RoseMark({ size, className }: BrandMarkProps) {
  return (
    <svg
      className={className}
      width={size}
 ...
 */
export function RoseName() {
  return (
    <span className={css.name}>
      <strong className={css.title}>DeepSeek Harness</strong>
      <small className={css.subtitle}>Rose Dream</small>
    </span>
  )
}
