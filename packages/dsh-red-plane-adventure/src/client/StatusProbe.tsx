...
/** How many rows the flight log lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function RedPlaneStatusProbe({ useProjection, useSession }: StatusProbeProps) {
