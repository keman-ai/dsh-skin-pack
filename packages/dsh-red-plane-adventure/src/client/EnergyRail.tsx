...
/** What this skin calls the gauge — the prototype's sidebar bar and its right-rail card both read Flight Energy. */
const RAIL_LABEL = 'Fuel'
...
export function RedPlaneEnergyRail({ wide }: EnergyRailProps) {
