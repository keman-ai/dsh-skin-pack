/**
 * The Cosmic Exploration skin · host half.
 *
 ...
 *
 * @module dsh-cosmic-exploration
 */

import type { Context } from '@deepseek-ai/cordis'
import type { IncomingMessage, ServerResponse } from 'node:http'
import { COSMIC_COVER } from './cover.generated.ts'

/** Plugin name (the `name` of the loader entry). */
export const name = 'cosmic'
 ...
 */
export const COVER_ROUTE = '/skin-cover/cosmic.webp'
...
export interface Config {
  /**
   * Switch to Cosmic Exploration on install; on by default. Turned off, it only registers without applying, leaving the user to pick it in the skin market.
   *
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.logger.info('[cosmic] Cosmic Exploration mounted (%s)', mode)
}
