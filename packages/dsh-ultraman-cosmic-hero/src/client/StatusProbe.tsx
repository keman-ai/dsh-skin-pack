...
/** How many rows the beam-call card lists at most. Beyond that only a total is reported — the right column is a status dock, not a log. */
...
export function CosmicStatusProbe({ useProjection, useSession }: StatusProbeProps) {
